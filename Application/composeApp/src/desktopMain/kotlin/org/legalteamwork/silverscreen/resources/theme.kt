...
object ResourceManagerTheme {
    ...
    val RESOURCE_MANAGER_BACKGROUND_COLOR = Color.DarkGray
...
// Здесь будет цвет той сущности
    val VIDEO_TRACK_BACKGROUND_COLOR = Color(0x99F4F2F2)

    val AUDIO_TRACK_BACKGROUND_COLOR = Color(0x99F4F2F2)

    val EDITING_PANEL_BACKGROUND = Color.Black
    val TOOL_PANEL_COLOR = Color(0xFF444444)
    val TOOL_BUTTONS_BACKGROUND_COLOR = Color(0xFF3A3A3A)
...
object SourcesMenuButtonTheme {
    ...
    val PATH_WINDOW_COLOR = Color(0xFF3A3A3A)
    val PATH_WINDOW_TEXT_COLOR = Color.White
    val NAV_WINDOW_BACKGROUND_COLOR = Color(0xFF3A3A3A)
    val BUTTON_OUTLINE_COLOR = Color.LightGray
    val LIST_VIEW_RESOURCES_OUTLINE_COLOR = Color(0x44000000)
    val LIST_VIEW_ADDITIONAL_INFO_COLOR = Color.Gray
    val LIST_ADD_BUTTON_OUTLINE_COLOR = Color(0x44000000)
